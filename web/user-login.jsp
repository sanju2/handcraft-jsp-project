...
<%
    ...
    session.putValue("usern", usern);
    String pass = request.getParameter("pass");
    Class.forName("com.mysql.jdbc.Driver");
    java.sql.Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/handcraft", "root", "");
    Statement st = con.createStatement();
    ResultSet rs = st.executeQuery("select * from customer where usern='" + usern + "' and pass='" + pass + "'");
    try {
        rs.next();
        if (rs.getString("pass").equals(pass) && rs.getString("usern").equals(usern)) {
            String redirectURL = "user-dashboard.jsp";
...
<html>
    <head>
        ...
        <title>Handcraft Shopping - Customer Login</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="row my-4">
                ...
                <!-- /.col-lg-8 -->
                <div class="col-lg-5">
                    <h1>Handcraft Shopping Customer Login</h1>
                    <form action="#" method="POST">
                        <table border="0">
                            <tbody>
                                ...
                                <tr>
                                    <td>Username </td>
                                    <td><input type="text" name="usern" value="" size="30" /></td>
                                </tr>
                                <tr>
                                    <td>Password </td>
