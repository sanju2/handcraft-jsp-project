...
<html>
    <head>
        ...
        <title>Handcraft Shopping - Order Details Actions</title>
                        ...
                        <table class="table table-responsive" cellpadding="0" width="80%">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td><a href="order-details-update.jsp?id=<%=id%>" class="btn btn-success" role="button">Edit</a></td>
                                    <td><a href="order-details-delete.jsp?id=<%=id%>" class="btn btn-danger" role="button">Delete</a></td>
                                </tr>
